...
#This script takes as input embryoCountsresult_with_length.txt which is the combination of all counts with the addition of the lenght of gene from flybase
#output file is the RPKM for 59 samples
...
write.table(gene,file="rpkm59_exp50_genes_least_50_samples.tab",sep="\t",quote=F,row.names=F)
